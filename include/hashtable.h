 ...
 */
void _cdecl hash_table_element_delete(hash_table_t *, hash_table_element_t *);
 ...
 * @returns NULL when no memory
 */
hash_table_t * _cdecl hash_table_new(hash_table_mode_t);

/**
 * Function to delete the hash table
 * @param table hash table to be deleted
 */
void _cdecl hash_table_delete(hash_table_t *);
 ...
 * @returns -1 when no memory
 */
int _cdecl hash_table_add(hash_table_t *, void *, size_t, void *, size_t);
 ...
 * @returns -1 when key is not found
 */
int _cdecl hash_table_remove(hash_table_t *, void *, size_t);
 ...
 * @returns void* pointer to the value in the table
 */
void * _cdecl hash_table_lookup(hash_table_t *, void *, size_t);
 ...
 * @returns 1 when key is found
 */
int _cdecl hash_table_has_key(hash_table_t *, void *, size_t);
 ...
 */
size_t _cdecl hash_table_get_keys(hash_table_t *, void **);
 ...
 */
size_t _cdecl hash_table_get_elements(hash_table_t *, hash_table_element_t *** );
 ...
 */
int _cdecl hash_table_resize(hash_table_t *, size_t);
